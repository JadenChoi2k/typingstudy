    ...
    public List<TypingDoc> recommend(Long userId, int page) {
        ...
        if (Arrays.asList(environment.getActiveProfiles()).contains("prod")) {
            ...
            return em.createQuery("select" +
                            ...
                            " or (doc.reviewCount = 1 and FUNCTION('TIMESTAMPDIFF', DAY, doc.createdAt, current_timestamp) > 0 and FUNCTION('TIMESTAMPDIFF', DAY, doc.createdAt, current_timestamp) < 4)" +
                            ...
                            " or (doc.reviewCount = 3 and FUNCTION('TIMESTAMPDIFF', DAY, doc.createdAt, current_timestamp) > 24 and FUNCTION('TIMESTAMPDIFF', DAY, doc.createdAt, current_timestamp) < 31)" +
        ...
        return em.createQuery("select" +
                        ...
                        " or (doc.reviewCount = 1 and FUNCTION('datediff', 'day', doc.createdAt, current_timestamp) > 0 and FUNCTION('datediff', 'day', doc.createdAt, current_timestamp) < 4)" +
                        ...
                        " or (doc.reviewCount = 3 and FUNCTION('datediff', 'day', doc.createdAt, current_timestamp) > 24 and FUNCTION('datediff', 'day', doc.createdAt, current_timestamp) < 31)" +
                        ") order by doc.createdAt desc", TypingDoc.class)
                .setParameter("userId", userId)
                .setMaxResults(20)
                .setFirstResult(page * 20)
